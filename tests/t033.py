...
# @pconfig(legacy_mode=True)
# class SecondLegacyConfig(LegacyConfig, StubbedLegacyConfig):
#     tree: float
#     shed: float
# 
# 
# default_second_legacy_config = SecondLegacyConfig(
#     default_legacy_config.inputs,
#     tree=1.0,
#     shed=2.0,
# )
# 
...
# @pconfig(legacy_stub=StubbedLegacyConfig)
...
# 
# assert auto_default_constructed.thing == 4
# assert auto_default_constructed.other == 2
# assert auto_default_constructed.tree == 1.0
# assert auto_default_constructed.shed == 2.0
